...
public class ControllerTelaPrincipal implements Initializable {
  ...
  *****************************************************************/
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    threadNave2 = new ThreadNave(imagemNave2, 2, sliderNave2, circulos);
    threadNave3 = new ThreadNave(imagemNave3, 3, sliderNave3, circulos);
    ...
    botaoPR6.setOnMouseExited(event -> aplicarEscala(imagemBotaoPausa6, 1.0));
    imagemBotaoPausa7.setOnMouseEntered(event -> aplicarEscala(imagemBotaoPausa7, 1.05));
    botaoPR7.setOnMouseExited(event -> aplicarEscala(imagemBotaoPausa7, 1.0));
    imagemBotaoPausa8.setOnMouseEntered(event -> aplicarEscala(imagemBotaoPausa8, 1.05));
    botaoPR8.setOnMouseExited(event -> aplicarEscala(imagemBotaoPausa8, 1.0));

    //Configuracao de onMouseEntered e onMouseExited para as imagens de retomada dos botoes de pausa/retomada das naves 1 a 8
    imagemBotaoRetomada1.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada1, 1.05));
    botaoPR1.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada1, 1.0));
    imagemBotaoRetomada2.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada2, 1.05));
    botaoPR2.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada2, 1.0));
    imagemBotaoRetomada3.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada3, 1.05));
    botaoPR3.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada3, 1.0));
    imagemBotaoRetomada4.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada4, 1.05));
    botaoPR4.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada4, 1.0));
    imagemBotaoRetomada5.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada5, 1.05));
    botaoPR5.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada5, 1.0));
    imagemBotaoRetomada6.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada6, 1.05));
    botaoPR6.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada6, 1.0));
    imagemBotaoRetomada7.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada7, 1.05));
    botaoPR7.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada7, 1.0));
    imagemBotaoRetomada8.setOnMouseEntered(event -> aplicarEscala(imagemBotaoRetomada8, 1.05));
    botaoPR8.setOnMouseExited(event -> aplicarEscala(imagemBotaoRetomada8, 1.0));
  } //Fim initialize
